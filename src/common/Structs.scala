...
trait StructExp extends StructOps with StructTags with BaseExp with AtomicWrites with EffectExp with VariablesExp with ObjectOpsExp with StringOpsExp with OverloadHack {
